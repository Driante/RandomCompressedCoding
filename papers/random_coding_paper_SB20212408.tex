...
\begin{figure}[ptb]
\centering
\includegraphics[width=\textwidth]{figure2.pdf}\caption{\textbf{Error
...
\begin{figure}[p]
\centering
\includegraphics[width=\textwidth]{figure4.pdf}\caption{ \textbf{Scaling of the optimal width and optimal error as a function of population size and signal-to-noise ration.} In all simulations $L=500$, and results are averaged over 8 network
...
\end{figure}\clearpage
\begin{figure}[p]
\includegraphics[width=\textwidth]{figure5.pdf}\caption{\textbf{Compressed coding for high-dimensional stimuli.} Here, for numerical results, we illustrated the case of a three-dimensional stimulus, $L=3375$ , $\eta^{2} =1$, $R=1$; results are  averaged over 8 network
realizations. 
\emph{continue to next page}}
\end{figure}
...
\begin{figure}[ptb]
\centering
\includegraphics[width=\textwidth]{figure6.pdf}\caption{\textbf{Linear vs
...
\begin{figure}[ptb]
\centering
\includegraphics[width=\textwidth]{figure8.pdf}\caption{\textbf{Effects of
...
\begin{figure}[ptb]
\centering
\includegraphics[width=\textwidth]{figure_methods.pdf}\caption{ \textbf{Model
